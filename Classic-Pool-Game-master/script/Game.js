...
/*
 ** Refatoração 4: Replace Constructor with Factory Method
 **
 ** Essa refatoração substitui a construção direta de objetos por meio de um construtor
 ** por um método de fábrica que encapsula a lógica de criação. Isso pode ser útil para
 ** controlar a instânciação, aplicar padrões de design como Singleton, ou simplesmente
...
/* Adição do método de fábrica */
function createGame() {
  return new Game_Singleton();
}
...
/* Chamada do método fábrica [antes const game = new Game(); ] */
var Game = createGame();
