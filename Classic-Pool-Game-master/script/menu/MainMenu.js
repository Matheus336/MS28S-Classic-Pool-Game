  ...
  buttons = buttons.concat([
    ...
    new Button(
      ...
      function () {
        ...
        /*
         ** Feature 2: Níveis de dificuldade irreais, foi reduzida a quantidade de iterações de
         ** treinamento da IA para 15, 30, 50 e 200, para os níveis fácil, médio, difícil e insano
         ** respectivamente.
         **
         ** Antes os valores estavam em 30, 50, 100 e 700 iterações, o que tornava o jogo muito
         ** difícil, especialmente no nível insano, onde a IA era praticamente invencível.
         */
